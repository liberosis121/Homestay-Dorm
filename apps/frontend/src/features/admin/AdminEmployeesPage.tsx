    ...
    <div className="space-y-6 animate-fade-in-up" style={{ fontFamily: 'Lexend, sans-serif' }}>
                  ...
                  >
                    ...
                    <td className="px-5 py-3">
                      <div className="flex justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button onClick={e => { e.stopPropagation(); setSelected(emp); setIsEditing(true); }}
            ...
            <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-5">
              <div className="flex flex-col items-center text-center gap-3">
                <div className="w-20 h-20 rounded-full flex items-center justify-center text-3xl font-bold text-white"
                  style={{ background: A.primary }}>{(editEmp?.full_name || selected.full_name).charAt(0).toUpperCase()}</div>
                <div>
                  <h3 className="text-xl font-bold" style={{ color: A.primary }}>{editEmp?.full_name || selected.full_name}</h3>
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center"
          ...
          <div className="w-full max-w-lg rounded-2xl shadow-2xl p-6 flex flex-col gap-4"
            style={{ background: A.surface }}>
